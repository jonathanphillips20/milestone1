...
public class Server3 {
	...
	public Server3(String input,String s[],int port[]){
		...
		if(candidates.length==1&&candidates[0].equals("")) {
			System.out.println("Invalid/Empty input file"); return;
		}
	...
	public static void main(String args[]){
		if(args.length<2){
			System.out.println("Incorrect input parameters. Please use java server3 <candidates> <ip:port> <ip:port> ... <ip:port>"); return;
		}
